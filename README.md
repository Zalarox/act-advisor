...
An app to self-track your ACT skills.

## What is ACT?

ACT (Acceptance and Commitment Therapy) is a modern therapy modality. You can read more about it [here](https://www.psychologytoday.com/ca/therapy-types/).
...
1. Clone the project `git clone https://github.com/Zalarox/act-advisor.git`
2. Install dependencies `pnpm install`
3. Run the 'dev' script `pnpm run dev`
